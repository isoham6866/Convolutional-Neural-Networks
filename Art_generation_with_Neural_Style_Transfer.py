"""
Created on Sun September 09 10:09:09 2018
@author: soham ghosh
"""
...
def compute_content_cost(a_C, a_G):
    ...
    a_G_unrolled = tf.reshape(a_C,[m, n_H*n_W, n_C])
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = (1/np.square(2*n_C*n_H*n_W))*tf.reduce_sum(tf.square(tf.subtract(GS, GG)))
    ### END CODE HERE ###
